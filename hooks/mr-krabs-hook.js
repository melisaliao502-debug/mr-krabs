#!/usr/bin/env node
// Mr. Krabs Desktop Pet — Claude Code Hook Script
// Zero dependencies, fast cold start, 1s timeout
// Usage: node mr-krabs-hook.js <event_name>
...
function send(sessionId, cwd) {
  ...
  if (_claudePid) {
    ...
    body.claude_pid = _claudePid; // backward compat with older Mr. Krabs versions
  }
